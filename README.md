...
#### 这个分支仅做介绍，需要源码请下载对应其他分支

#### master分支是连接了Java后端的代码，对Mysql数据库进行了操作，如果不熟悉后端的话，可以先使用noback分支
...
![image-20250504152836834](./img/image-20250504152836834.png)![image-20250504152848878](./img/image-20250504152848878.png)![image-20250504154447282](./img/image-20250504154447282.png)![image-20250504154454467](./img/image-20250504154454467.png)
